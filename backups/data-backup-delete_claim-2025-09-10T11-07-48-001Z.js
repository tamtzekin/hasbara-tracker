...
const summaries = [
    ...
    },
    {
        ...
        "customUrl": "hamas-chemical-weapons"
    },
    {
        ...
        "customUrl": "israel-denies-church-killing"
    },
    {
        ...
        "customUrl": "israeli-soldier-helps"
    },
    {
        ...
        "customUrl": "palestinian-captives-stripped"
    },
    {
    ...
    {
        "claimMainTitle": "Flower run",
        "claimSummary": "Flower run description",
        "customUrl": "flower-run-two"
    }
];
...
const data = [
    ...
    },
    {
        ...
        "description": {
            ...
            "details": "Pallywood is a term which combines the words ‘Palestine’ and ‘Hollywood’ to suggest that Palestinians produce fabricated or manipulated media content to gain sympathy for the cause and to influence public opinion of the Israeli occupation.<br><br>It is used to dismiss the reality of Palestinians by claiming there is a deliberate effort to stage events, create misleading narratives, or exaggerate circumstances in order to portray the Israeli military occupation as the aggressors. It is a form of atrocity denial, used by the Israeli state and its supporters in an attempt to exonerate itself.<br><br>The term started being used following the killing of 12-year-old Palestinian boy Muhammad al-Durrah in Gaza by Israeli forces during the Second Intifada in 2000. The Israeli state and its pundits launched a denial campaign, questioning the authenticty of the photographic and video evidence by France24. The Israeli state initially admitted that it had killed Muhammad al-Durrah, then retracted it.<br><br> American author Richard Landes, who specialises in ‘medieval millennial thinking’, credits himself with coining the term and popularising it through his online documentary titled ‘Pallywood: According to Palestinian Sources’ published in 2005."
        },
        "sources": [
            {
    ...
    },
    {
        ...
        "description": {
            ...
            "details": "The son of elderly Palestinian man Bashir Hajji described how his father was shot and killed by Israeli snipers on Salah Al-Din Street near a roundabout in Gaza in an interview with Arabic broadcaster Al-Araby on 9 November, 2023.<br><br>He recounted that his elderly parents were attempting to walk further south of Gaza, in the Israeli-named ‘humanitarian corridor’ that the Israeli state has been forcibly displacing Palestinians into.<br><br>Bashir Hajji’s son said in the interview:<br><br><em>My parents and I were trying to get to the southern area. After the Kuwaiti roundabout we found a man with a cart who was transporting the elderly.<br><br>I wanted to transport my elderly father on the cart. I carried our belongings and started walking, and I could hear their voices behind me. In that area, you can’t look around or turn to see behind you. Suddenly, I couldn’t hear them anymore. I turned around and couldn’t find my parents or the cart.<br><br>I sent back some of the young men who were going back and forth. I saw my mother in a car and felt relieved, and then a man told me that he had gotten my father out. I was relieved and started running to reach them.<br><br>They told me he (my father) was lying inside. I went in thinking he had had a diabetic attack, as he gets those sometimes. I went into the Bakron Building to locate him, and found him dead, and they tried to shoot at the building while we were getting his body out.</em>"
        },
        "sources": [
            {
                "sourceName": "Al-Araby",
    ...
    },
    {
        ...
        "description": {
            "summary": "Israeli state shares image of elderly Palestinian man in Gaza portraying a soldier ‘helping’ him",
            "details": "Days later, the official Israeli state’s Arabic account on X (formerly Twitter) posted an image with two photos side by side to contrast how Israelis treat the elderly compared to Palestinians.<br><br>The photo on the left with Arabic text translating to ‘terrorist organisation’ showed a Palestinian resistance fighter with a seated elderly settler doing the peace sign with a rifle on her lap from the Al-Aqsa Flood operation on 7 October, 2023. The woman was unharmed.<br><br>The photo on the right with Arabic text translating to ‘Israel’ showed an Israeli soldier in Gaza seemingly speaking to an elderly Palestinian man with a walking stick.<br><br>The post’s text lauded the morals and politeness of Israel Occupation Force soldiers. It read (from Hebrew to English):<br><br><em>Among the obligations and morals of the three heavenly religions: Islam, Judaism, and Christianity, are honouring one’s parents and the elderly, being kind to them, and being polite to them in word and deed.’<br><br>It says in the Bible in the Book of Exodus: Honour your father and your mother, so that your days may be long in the land that the Lord your God is giving you. The IDF soldiers adhere to and work according to this lofty principle, while the monsters of Hamas and Islamic Jihad, who have no religion or morals, kidnap the elderly and detain them in harsh conditions.</em>"
        },
        "sources": [
            {
    ...
    },
    {
        ...
        "description": {
            ...
            "details": "The independent non-profit organisation Euro-Med Human Rights Monitor identified the elderly man as Bashir Hajji in the photo shared by the Israeli state. The organisation confirmed identification with Bashir Hajji’s granddaughter, Hala, who also posted a eulogy to her grandfather on Instagram.<br><br>Her Instagram story read (Arabic to English):<br><br><em>I want the whole world to know your story, my grandfather. My grandfather was tired. He was 75 years old. He was walking in the corridor of death, which they said was a safety corridor. He wanted to flee to the south. Because of the bombing around him, he got lost among the people and my uncle was unable to reach him.<br><br> They (Israeli forces) started trampling on (attacking) the people, but my grandfather did not manage to escape and was betrayed by his crutch. And the whole world betrayed him and betrayed him. He kept walking alone. We talked to him and said that there was no one around him.<br><br>We contacted the first aid and the Red Cross, but no one was able to do anything. Then he told us that he sat in a bombed house, taking shelter until someone could come to take him. My uncle was close to the area and reached (the shelter) in the morning. He went to the place where he was and looked for him until he found him.<br><br>They shot him in the head and back while he was sleeping. My grandfather was killed tired, cold, thirsty and hungry.</em><br><br>In an Instagram post, Hala shared the photo being used by Israeli forces to claim they were helping the elderly alongside an image of her slain grandfather’s body.<br><br>The caption read (Arabic to English):<br><br><em>They (the Israeli state) want to show the world that they helped my grandfather and that they are humanitarian but in reality they killed him. God is enough for us. (You are) among the martyrs in heaven, my grandfather, my love.</em>"
        },
        "sources": [
            {
                "sourceName": "Instagram",
    ...
    },
    {
        ...
        "description": {
            "summary": "Flower run description",
            "details": ""
        },
        "sources": [
            {
        ...
        "lastEditedAt": "2025-09-10T11:07:14.770Z"
    }
];
