...
const ClaimA = () => {
 ...
 <tr>
  <td><div class="date">OCT 11, 2023</div></td>
  <td>IDF says it won't back up its claim that Hamas decapitated babies in Israel because it is ‘disrespectful for the dead’.</td>
