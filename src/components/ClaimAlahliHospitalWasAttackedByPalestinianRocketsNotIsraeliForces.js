...
export default function ClaimAlahliHospitalWasAttackedByPalestinianRocketsNotIsraeliForces() {    
    const metadataProps = {
        url: "https://hasbaratracker.com/al-ahli-hospital-was-attacked-by-palestinian-rockets-not-israeli-forces",
        title: summaries[1].claimMainTitle,
        description: summaries[1].claimSummary,
        
        twitterTitle: summaries[1].claimMainTitle,
        twitterDescription: summaries[1].claimSummary,
        twitterUrl: "https://hasbaratracker.com/al-ahli-hospital-was-attacked-by-palestinian-rockets-not-israeli-forces",
    };
    ...
    const filteredData = useMemo(() => {
        if (!selectedClaimTitle) {
            return data.filter(item => item.claimTitle === summaries[1].claimMainTitle);
        }
