    ...
    const {
    ...
    } = useTable(
        {
            ...
            initialState: {
                ...
                globalFilter: 'Hamas were carrying instructions on how to make chemical weapons'
            },
                ...
                <Link to="/">
                    ...
                    <div className="claim-summary container mt-7 mobile:w-[90%] mobile:mt-[5%]">
                        <div className="mobile:text-xs laptop:w-7/12 laptop:text-md font-mono mt-2 font-bold">
                            The claim</div>
                        <div className="mobile:mt-0 mobile:text-xs laptop:text-md laptop:w-7/12 mb-2 mt-1">‘Hamas were carrying instructions on how to make chemical weapons’</div>
