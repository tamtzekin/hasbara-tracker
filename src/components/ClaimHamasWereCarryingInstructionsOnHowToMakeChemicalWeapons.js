...
export default function ClaimHamasWereCarryingInstructionsOnHowToMakeChemicalWeapons() {    
    const metadataProps = {
        url: "https://hasbaratracker.com/hamas-were-carrying-instructions-on-how-to-make-chemical-weapons",
        title: summaries[4].claimMainTitle,
        description: summaries[4].claimSummary,
        
        twitterTitle: summaries[4].claimMainTitle,
        twitterDescription: summaries[4].claimSummary,
        twitterUrl: "https://hasbaratracker.com/hamas-were-carrying-instructions-on-how-to-make-chemical-weapons",
    };
    ...
    const filteredData = useMemo(() => {
        if (!selectedClaimTitle) {
            return data.filter(item => item.claimTitle === summaries[4].claimMainTitle);
        }
