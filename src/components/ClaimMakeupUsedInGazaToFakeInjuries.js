...
export default function ClaimMakeupUsedInGazaToFakeInjuries() {    
    const metadataProps = {
        url: "https://hasbaratracker.com/makeup-used-in-gaza-to-fake-injuries",
        title: summaries[3].claimMainTitle,
        description: summaries[3].claimSummary,
        
        twitterTitle: summaries[3].claimMainTitle,
        twitterDescription: summaries[3].claimSummary,
        twitterUrl: "https://hasbaratracker.com/makeup-used-in-gaza-to-fake-injuries",
    };
    ...
    const filteredData = useMemo(() => {
        if (!selectedClaimTitle) {
            return data.filter(item => item.claimTitle === summaries[3].claimMainTitle);
        }
