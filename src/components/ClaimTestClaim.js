...
export default function ClaimTestClaim() {    
    const metadataProps = {
        url: "https://hasbaratracker.com/test-claim",
        ...
        twitterUrl: "https://hasbaratracker.com/test-claim",
    };
    ...
    const filteredData = useMemo(() => {
        if (!selectedClaimTitle) {
            return data.filter(item => item.claimTitle === summaries[0].claimMainTitle);
        }
