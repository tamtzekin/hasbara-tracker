...
export default function ClaimThisIsANewClaim() {    
    const metadataProps = {
        url: "https://hasbaratracker.com/this-is-a-new-claim",
        title: summaries[9].claimMainTitle,
        description: summaries[9].claimSummary,
        
        twitterTitle: summaries[9].claimMainTitle,
        twitterDescription: summaries[9].claimSummary,
        twitterUrl: "https://hasbaratracker.com/this-is-a-new-claim",
    };
    ...
    const filteredData = useMemo(() => {
        if (!selectedClaimTitle) {
            return data.filter(item => item.claimTitle === summaries[9].claimMainTitle);
        }
