...
const ClaimsList = () => {
    ...
    <>
        ...
        <Link to="/israeli-state-denies"><div className="claim-link">'Israeli state denies killing mother and daughter seeking refuge in Gaza’s Holy Family Parish'</div></Link>
        <Link to="/israeli-soldier-helps"><div className="claim-link">'Israeli soldier helps elderly Palestinian man in ‘safe corridor’'</div></Link>
        <Link to="/palestinian-captives-stripped"><div className="claim-link">'Palestinian captives stripped down naked because of ‘warm weather’ in the Middle East, says Mark Regev'</div></Link>
