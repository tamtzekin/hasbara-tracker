...
const data = [
...

    {
        ...
        sourceText: 'Fox News: Biden making remarks on U.S. support for Israel',
...

    {
        ...
        sourceText: 'CNN: Netanyahu’s office releases photos of “babies murdered and burned” by Hamas',
...

    {
        ...
        sourceText: 'Insider: IDF says it won’t back up its claim that Hamas decapitated babies in Israel because it is ‘disrespectful for the dead’',
...

    {
        ...
        sourceText: 'LBC: Toddlers, babies with their heads cut off',
    ...
    
    {
        ...
        description: {
            summary: 'Israeli occupation reservist David Ben Zion is a settler leader who incited riots',
            summaryClass: 'expand-text',
        ...
        sourceText: 'Metro: 40 babies murdered by Hamas',
    ...
    
    {
        ...
        sourceText: 'CNN: Israeli official says government cannot confirm babies were beheaded in Hamas attack',
...

    {
        ...
        sourceText: 'The Jerusalem Post on X',
...

    {
        ...
        sourceText: 'NBC News NO SOURCE LINK?',
        sourceLink: '',
        videoLink: '',
    },    
    
    {
        ...
        sourceText: 'Al Jazeera: Watching the watchdogs: Babies and truth die together in Israel-Palestine',
...

    {
        ...
        sourceText: 'The White House: Remarks by President Biden on the October 7th Terrorist Attacks and the Resilience of the State of Israel and its People',
...

    {
        ...
        sourceText: 'New York Post: Head of Israel’s EMS service describes horror of seeing babies slaughtered by Hamas',
...

    {
        ...
        sourceText: 'The Intercept: Joe Biden keeps repeating his false claim that he saw pictures of beheaded babies',
...

    {
        ...
        sourceText: 'The White House: ‘Remarks by President Biden at a Campaign Reception',
