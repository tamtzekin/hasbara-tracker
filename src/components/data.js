...
const data = [
...

    {
        ...
        sources: [
            {
                sourceText: 'i24NEWS',
                sourceLink: 'https://www.hasbaratracker.com/i24NEWS_10Oct.mp4',
...

    {
        ...
        sources: [
            {
                sourceText: 'CNN',    
                sourceLink: 'https://www.hasbaratracker.com/CNN_NicRobertson_10Oct.mp4',
